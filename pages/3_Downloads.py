...
with st.spinner('This page might take a while to load. Please wait...'):
    ...
    def main():
        ...
        original_title = '<p style="font-size: 20px;font-family:sans-serif">Interface Dataset: Information about' \
        ...
        original_title = '<p style="font-size: 20px;font-family:sans-serif">Interface Dataset FDA-approved drugs subset</p>'
        st.markdown(original_title, unsafe_allow_html=True)
        st.download_button(
        ...
        original_title = '<p style="font-size: 20px;font-family:sans-serif">Protein Dataset: Contains summary information about PDB structures.</p>'
        st.markdown(original_title, unsafe_allow_html=True)
        st.download_button(
        ...
        original_title = '<p style="font-size: 20px;font-family:sans-serif">Protein Dataset FDA-approved drugs subset</p>'
        st.markdown(original_title, unsafe_allow_html=True)
        st.download_button(
        ...
        st.empty()
        st.empty()
        original_title = '<p style="font-size: 20px;font-family:sans-serif">Ligand Dataset FDA-approved drugs subset</p>'
        st.markdown(original_title, unsafe_allow_html=True)
        st.download_button(
        ...
        st.empty()
        st.empty()
        original_title = '<p style="font-size: 20px;font-family:sans-serif">Eliminated Molecules: Eliminated small-molecule list</p>'
        st.markdown(original_title, unsafe_allow_html=True)
        st.download_button(
        ...
        st.empty()
        st.empty()
        original_title = '<p style="font-size: 20px;font-family:sans-serif">List of Drugs that are found in the interfaces: 2,214 small-molecules that are found to be binding to at least one interface region</p>'
        st.markdown(original_title, unsafe_allow_html=True)
        st.download_button(
